...
1.	From the "My Cloud Services" Dasboard accessible at https://myservices.us2.oraclecloud.com/mycloud/cloudportal/dashboard, toggle "Identity Domain" selector to your "Traditional" domain, then click on `Management Cloud` as shown below
