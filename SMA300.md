...
1. Click on each one in turn and review the Definition as well as the Parameters available 
...
1. Switch back to your browser and to the Uploads page. Click the ‘hamburger’ icon in the csd_target_attack row and select View in Log Explorer
...
1. Switch back to your browser and to the Uploads page. Click the ‘hamburger’ icon in the csd_multi_failed_login row and select View in Log Explorer
...
1.	Switch back to your browser and to the Uploads page. Click the ‘hamburger’ icon in the csd_brute_force_attack row and select View in Log Explorer
